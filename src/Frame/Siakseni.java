 ...
 * @author Daeng
 */
public class Siakseni extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Siakseni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
